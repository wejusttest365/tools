    ...
    <div className="page-wrap">
      <main className="main-col">
        ...
        <section className="tool-info">
          <Accordion title={`Why use ${title}?`} isOpen={false} content={
            <div>
          ...
          <Accordion title={`How to use ${title}`} isOpen={false} content={
            <div>
              <ol>
          ...
          <Accordion title="Available Tools" isOpen={true} content={
            <div>
