...
export default function AIThumbnails() {
  ...
  const handleGenerateHeadline = () => {
    const nextHeadline = getRandomItem(aiHeadlineSuggestions);
    setSavedHeadline(nextHeadline);
    setTitle(nextHeadline);
  };
              ...
              <div className="grid gap-4 rounded-3xl border border-white/10 bg-slate-900/80 p-5">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between gap-3 text-sm text-slate-300">
                    <span>Glow</span>
                    <span className="font-semibold text-white">{glowStrength}%</span>
                  </div>
                  <input
                    type="range"
                    min={32}
              ...
              <div className="overflow-hidden rounded-[32px] border border-white/10 bg-black/10 p-4" ref={previewRef}>
                <div className="relative aspect-[16/9] overflow-hidden rounded-[28px] bg-slate-950" ref={dragConstraintsRef}>
                  ...
                  >
                    ...
                    <h3 style={{ color: textColor }} className="mt-3 text-4xl font-black leading-[0.95] tracking-[-0.04em] text-white">
                      {previewHeadline}
                    </h3>
                  </div>
                  ...
                  >
                    <p className="text-base leading-7 text-white/85">{previewSubtitle}</p>
                  </div>
          ...
          <aside className="space-y-6 rounded-[32px] border border-white/10 bg-slate-950/80 p-6 shadow-soft backdrop-blur-xl">
            ...
            <div className="rounded-3xl border border-white/10 bg-slate-900/80 p-5">
              <div className="mb-4 flex items-center justify-between gap-3">
                ...
                <span className="rounded-full bg-cyan-500/15 px-3 py-2 text-xs uppercase tracking-[0.28em] text-cyan-200">Live</span>
              </div>
              <div className="space-y-4">
